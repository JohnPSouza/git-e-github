...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <div><img src="imagens/icone_twitter.png" /></div>
      </div>
...
<div style="margin:2%;"><center><figure><img src="imagens/icone_twitter.png" width="60" height="60" title="IFG Messeger"/></figure></center></div>

<div class="container span7 text-center col-md-4 col-md-offset-4">			
<center>
<form class="form-group" class="col-md-12" method="post" action="index.php">
	<div class="etc-login-form">
		<h5 style="text-align:center;">E-mail com instruções para redefinir sua senha enviado! <br /></h5><br />
		    <h4>Verifique seu e-mail!</h4>
	</div>
    <br />
  <button type="submit" class="btn btn-primary" title='Página Inicial'>IFG Messeger</button>
