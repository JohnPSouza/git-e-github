	...
	<body>
	    ...
	    <nav class="navbar navbar-inverse navbar-static-top">
	      <div class="container">
	        ...
	        <div><a class="navbar-brand" href="home.php" title="Atualizar Página">IFG Messeger</a></div>
	    			...
	    			<div class="panel-body">
	    				<form id="form_tweet" class="input-group">
	    					...
	    					<span class="input-group-btn">
	    						<button class="btn btn-default" id="btn_tweet" type="button" style="color:#0040FF">Tweet</button>
	    					</span>
	    				</form>
	    			</div>
	    		</div>
